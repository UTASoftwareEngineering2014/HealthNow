 ...
 */
public class BreakfastReportActivity extends Activity {
	private XYPlot plot;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_breakfast_report);
		 ...
		 */
		plot = (XYPlot) findViewById(R.id.breakfastReportPlot);
